package br.com.edn.commonsutils.loggingmethods;
...
public class LoggingAspect {
    ...
    @Around("@annotation(br.com.edn.commonsutils.loggingmethods.Logging)")
    ...
    private Object[] removeHiddenParameters(Object[] parameters, Method method) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (Arrays.stream(annotationsFromParam).noneMatch(a -> a instanceof Hidden)) {
